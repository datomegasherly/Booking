...
class About extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <div className="hero-wrap js-fullheight" style={{ backgroundImage: "url('/app/images/bg_2.jpg')" }}>
                    ...
                    <section className="ftco-section">
                        <div className="container">
                            <div className="row d-md-flex">
                                <div className="col-md-6 ftco-animate img about-image" style={{ backgroundImage: 'url(/app/images/about.jpg)' }}>
                                </div>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                ...
                                                <div className="card-header">
                                                        <a className="card-link" data-toggle="collapse"  href="#menuone" aria-expanded="true" aria-controls="menuone">When she reached the first hills? <span className="collapsed"><i className="icon-plus-circle"></i></span><span className="expanded"><i className="icon-minus-circle"></i></span></a>
                                                </div>
                                            ...
                                            <div className="card">
                                                <div className="card-header">
                                                        <a className="card-link" data-toggle="collapse"  href="#menutwo" aria-expanded="false" aria-controls="menutwo">Italic Mountains, she had a last <span className="collapsed"><i className="icon-plus-circle"></i></span><span className="expanded"><i className="icon-minus-circle"></i></span></a>
                                                </div>
                                            ...
                                            <div className="card">
                                                <div className="card-header">
                                                        <a className="card-link" data-toggle="collapse"  href="#menu3" aria-expanded="false" aria-controls="menu3"> Bookmarksgrove, the headline? <span className="collapsed"><i className="icon-plus-circle"></i></span><span className="expanded"><i className="icon-minus-circle"></i></span></a>
                                                </div>
                                            ...
                                            <div className="col-md-6">
                                                <div className="card">
                                                <div className="card-header">
                                                        <a className="card-link" data-toggle="collapse"  href="#menu4" aria-expanded="false" aria-controls="menu4">Alphabet Village and the subline of her own? <span className="collapsed"><i className="icon-plus-circle"></i></span><span className="expanded"><i className="icon-minus-circle"></i></span></a>
                                                </div>
                                            ...
                                            <div className="card">
                                                <div className="card-header">
                                                        <a className="card-link" data-toggle="collapse"  href="#menu5" aria-expanded="false" aria-controls="menu5">Then she continued her way? <span className="collapsed"><i className="icon-plus-circle"></i></span><span className="expanded"><i className="icon-minus-circle"></i></span></a>
                                                </div>
                                            ...
                                            <div className="card">
                                                <div className="card-header">
                                                        <a className="card-link" data-toggle="collapse"  href="#menu6" aria-expanded="false" aria-controls="menu6">Skyline of her hometown Bookmarksgrove? <span className="collapsed"><i className="icon-plus-circle"></i></span><span className="expanded"><i className="icon-minus-circle"></i></span></a>
                                                </div>
